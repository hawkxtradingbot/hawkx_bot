...
function getConfig() {
  return {
    ...
    pct:        parseFloat(db.getSysConfig("cashback_pct") || "0"),
    mode:       db.getSysConfig("cashback_mode") || "SOL",
    tokenMint:  db.getSysConfig("cashback_token_mint") || "",
    tokenLabel: db.getSysConfig("cashback_token_label") || "TOKEN",
    days:       parseInt(db.getSysConfig("cashback_days") || "0"),
    startTs:    parseInt(db.getSysConfig("cashback_start_ts") || "0"),
