...
async function test() {
  ...
  <!-- Divider -->
  <line x1="50" y1="315" x2="${W-50}" y2="315" stroke="rgba(255,255,255,0.15)" stroke-width="1"/>
  ...
  <!-- CENTER divider -->
  <line x1="${W/2}" y1="315" x2="${W/2}" y2="560" stroke="rgba(255,255,255,0.1)" stroke-width="1"/>
  ...
  <!-- Rank progress -->
  <line x1="50" y1="562" x2="${W-50}" y2="562" stroke="rgba(255,255,255,0.1)" stroke-width="1"/>
